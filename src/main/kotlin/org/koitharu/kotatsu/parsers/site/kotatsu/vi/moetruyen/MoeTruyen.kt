package org.koitharu.kotatsu.parsers.site.kotatsu.vi.moetruyen
...
@MangaSourceParser("MOETRUYEN", "Moè Truyện", "vi")
internal class MoeTruyen (context: MangaLoaderContext) :
    ...
    override suspend fun getListPage(page: Int, order: SortOrder, filter: MangaListFilter): List<Manga> {
        ...
        if (!filter.author.isNullOrEmpty()) {
            val author = filter.author?.splitByWhitespace()?.joinToString("+") { it }
            url.addEncodedQueryParameter("q", author)
        }
